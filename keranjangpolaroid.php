...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO polaroid (nama, kelas, jurusan, abjad_kelas, frame, link_gdrive, no_hp)
              VALUES ('$nama', '$kelas', '$jurusan', '$abjad', '$frame', '$link', '$no_hp')";

    if (mysqli_query($koneksi, $query)) {
        echo "<script>alert('Pesanan berhasil dikirim! Silakan hubungi admin kami di 083829372000'); window.location.href='polaroid.php';</script>";
    } else {
...
<a class="kembali" href="polaroid.php">↩️</a>

<div class="form-container">
  <h2>Pesan Polaroid</h2>
  <form method="POST">
    <label>Nama:</label>
